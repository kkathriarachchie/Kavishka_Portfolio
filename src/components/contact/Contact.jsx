            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">kkathriarachchie@gmail.com</span>
                        
                        <a href="mailto:kkathriarachchie@gmail.com" className="contact__button">
                            Write Me{" "} 
                    ...
                    <div className="contact__card">
                        <RiWhatsappLine className="contact__card-icon" />

                        <h3 className="contact__card-title">WhatsApp</h3>
                        <span className="contact__card-data">+94775696131</span>

                        <a href="https://wa.me/+94775696131" className="contact__button" target="_blank" rel="noopener noreferrer">
                            Message Me{" "}
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Kavishka Kathriarachchie</span>

                        <a href="https://m.me/kavishka.kathriarachchie" target="_blank" rel="noopener noreferrer" className="contact__button">
                            Message Me{" "}
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
